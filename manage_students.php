...
if(isset($_GET['del']) && !empty($_GET['del'])) {
    ...
    if(deleteStudent($id)) {
        setFlashMessage('success_msg', 'Student deleted successfully', 'alert-success');
    } else {
        setFlashMessage('error_msg', 'Failed to delete student', 'alert-danger');
    }
...
<body>
    <div class="wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-4 mb-4">Manage Students</h2>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <a href="bulk_import.php" class="btn btn-success btn-sm">
                                        <i class="fas fa-file-import"></i> Bulk Import
                                    </a>
                                    <a href="export_students.php" class="btn btn-info btn-sm">
                                        ...
                                        foreach($students as $student) {
                                            ...
                                            echo '<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="manage_students.php?del='.$student['id'].'" class="btn btn-sm btn-danger" 
