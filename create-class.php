...
$sql="INSERT INTO tblclasses(ClassName,ClassNameNumeric,Section,Scheme,Program,Semester) VALUES(:classname,:classnamenumeric,:section,:scheme,:program,:semester)";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Create MSBTE Class</h2>
                                </div>
                            </div>
                                            ...
                                            <div class="panel-body">
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Program/Department</label>
                                                        <div class="">
                                                            <select name="program" class="form-control" required="required" id="program">
                                                    ...
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <select name="scheme" class="form-control" required="required" id="scheme">
                                                                <option value="">Select Scheme</option>
                                                                <option value="I Scheme">I Scheme</option>
                                                                <option value="G Scheme">G Scheme</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <select name="semester" class="form-control" required="required" id="semester">
                                                    ...
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- First Year CO, Second Year ME etc</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group has-success">
